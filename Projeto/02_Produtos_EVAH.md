# 📦 PRODUTOS E SOLUÇÕES - EVAH E PLATAFORMA DOBEM TECNOLOGIA
...
A **Dobem Tecnologia** desenvolve e comercializa soluções de automação inteligente baseadas em Inteligência Artificial, focada no modelo de negócio **Vertical AI**.
...
## 🎯 1. DEFINIÇÃO E CONCEITO DO PRODUTO EVAH
...
- Framework modular que permite crescimento gradual do cliente

---

## 🔧 2. FUNCIONALIDADES E CAPACIDADES DO EVAH ASSISTANT
...
### 3.15 Agente Assistente Corporativo
...
## 🧩 5. MÓDULOS DO ECOSSISTEMA EVAH

### 5.1 EVAH Assistant (Evah Assistant)

**Assistente Inteligente de Vendas Automatizado para Humanos**
...
#### 5.1.2 Atendimento com Inteligência Artificial (IA)
...
### 5.2 EVAH Omni – Central de Gerenciamento Omnichannel de Atendimento (Chatwoot)
...
### 5.3 EVAH Connect – Módulo de integração que conecta canais
...
### 5.4 EVAH Maestro (EVAH Conductor) – Orquestrador de automações inteligentes utilizando n8n

O **EVAH Maestro** (também chamado de EVAH Conductor) é o núcleo de automações inteligentes do ecossistema **EVAH**, utilizando a plataforma open source **n8n** para criar, gerenciar e executar fluxos complexos que integram múltiplos sistemas, canais e processos empresariais. Seu design modular e escalável permite que a operação seja automatizada com alta flexibilidade, garantindo agilidade, controle e precisão.
...
### 5.5 EVAH Code – Serviços de desenvolvimento personalizados
...
### 5.6 EVAH ERP – Sistemas administrativos e financeiros
...
## 🎯 6. CASOS DE USO E OBJETIVOS

### 6.1 Objetivos do Assistente
...
### 6.3 Caso de Uso Específico: BiraBot (Bira Veículos)
...
## 🔄 10. INTEGRAÇÕES COM OUTROS MÓDULOS EVAH
...
### 10.2 EVAH Omni (Chatwoot)

- Encaminhamento para atendimento humano
- Histórico centralizado
- Gestão de conversas

### 10.3 EVAH Conductor (n8n)
...
### 11.7 Custos e Preços (Referência)
...
## 🛠️ 12. FERRAMENTAS OPEN SOURCE UTILIZADAS

A Dobem Tecnologia utiliza uma stack de ferramentas open source consolidadas:

- **Typebot** - Plataforma no-code/low-code para criar conversas interativas
- **Flowise** - Plataforma para construção de fluxos de IA
- **N8N** - Automação e orquestração de workflows
- **Chatwoot** - Central de gerenciamento omnichannel
- **Evolution API** - Integração WhatsApp
- **Odoo ERP** - Sistema de gestão empresarial
- **WordPress** - CMS e criação de sites
- **Keycloak** - Gerenciamento de identidade e acesso
- **OpenAI/Gemini** - Provedores de IA
- **Uptime Kuma** - Monitoramento de APIs, sites, etc.
- **Jhipster** - Framework de desenvolvimento
- **TicketZ** - Sistema de tickets

---

## 🎯 13. PRODUTOS ADICIONAIS - PRIME ASSISTANT (CHATBOT)

### 13.1 Visão Geral

**Prime Assistant** (também conhecido como **Dobem Bot**) é uma solução de chatbot desenvolvida pela Dobem Tecnologia.

**Componentes:** Typebot  
**Objetivo:** Fazer o atendimento dos clientes de uma empresa  
**Público alvo:** Qualquer empresa que precise atender vários clientes ao mesmo tempo e não possuem pessoas para isso

### 13.2 Segmentos de Mercado
...
- **Atendimento 24/7**: Chatbots podem responder a perguntas e resolver problemas a qualquer hora do dia, melhorando a satisfação do cliente
- **Redução de Custos**: Automatizando tarefas repetitivas, as empresas podem reduzir custos com atendimento ao cliente
- **Escalabilidade**: Chatbots podem lidar com múltiplas interações simultâneas, algo que seria difícil para uma equipe humana
- **Coleta de Dados**: Chatbots podem coletar dados valiosos sobre clientes, ajudando a personalizar serviços e produtos
- **Melhoria na Experiência do Cliente**: Proporcionam respostas rápidas e precisas, melhorando a experiência geral do cliente

### 13.4 Modalidades do Chatbot

**1. Chatbot Flow simples**
- Para interações estruturadas e previsíveis
- Guia clientes passo a passo
...
**Versão:** 1.0 - Consolidado Completo
